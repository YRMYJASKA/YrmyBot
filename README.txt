...
---------------------------------------------------------------------
HOW TO USE: 
example code of a very basic bot tih only one user implemented command 
...
The program can be cancelled by pressing Ctrl-C in the terminal or via "!shutdown".
...
YrmyBot is programmed in python 3 and using the PEP8 style for python.
Please format your code according to PEP8!
